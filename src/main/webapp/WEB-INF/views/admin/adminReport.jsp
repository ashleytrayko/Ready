...
<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
	...
	<ul class="nav nav-pills flex-column mb-auto">
		...
		<li><a href="/admin-notice" class="nav-link text-white"> 공지사항 </a></li>
		<li><a href="/admin-banner" class="nav-link text-white"> 배너관리  </a></li>
		<li><a href="/admin-report" class="nav-link text-white"> 신고관리  </a></li>
		<li><a href="/admin-product" class="nav-link text-white"> 상품관리  </a></li>
		<li><a href="/admin-order" class="nav-link text-white"> 주문관리  </a></li>
		<li><a href="/admin-qna" class="nav-link text-white"> Q&A관리  </a></li>
	</ul>
	<hr>
	<div class="dropdown">
