...
public class MypageController {
	...
	public String showModifySurvey() {
		return "mypage/modifySurvey";
	}
	
	//설문지 수정
	@RequestMapping(value="mypage/modifyForm.kh", method=RequestMethod.POST)
	public ModelAndView modifySurvey(ModelAndView mv, Principal principal) {
